...
export default function ProjectOrganizationCard() {
  ...
  const updateField = (field, value) =>
    setProjectOrgCard({ ...projectOrgCard, [field]: value });
  ...
  const handleSave = () => {
    console.log("Data saved:", projectOrgCard);
  };

  return (
    <PageWrapper title="Карточка проектной организации">
      <div className="grid grid-cols-7 gap-4">
        ...
        <div className="group-box border border-[--color-border] col-span-2">
          ...
          <div className="grid grid-cols-1 gap-4 mb-4">
            ...
            <Input placeholder="Выдан: Наименование СРО" value={sroName} onChange={(e) => updateField("sroName", e.target.value)} />
        ...
        <div className="group-box border border-[--color-border] col-span-5">
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            <Button onClick={handleAddEmployee} className="col-span-1">Добавить</Button>
          </div>
          <Table
