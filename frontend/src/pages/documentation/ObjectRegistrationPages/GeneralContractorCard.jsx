...
export default function GeneralContractorCard() {
  ...
  const updateField = (field, value) =>
    setGeneralContractorCard({ ...generalContractorCard, [field]: value });
  ...
  const handleSave = () => {
    console.log("Data saved:", generalContractorCard);
  };
      ...
      <div className="grid grid-cols-7 gap-4">
        <div className="col-span-3">
          <ComboBox
            ...
            onChange={(value) => updateField("selectedOrganization", value)}
          />
        </div>
